<div class="install-container">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <p class="card-text mb-4">Please enter your Database's Connection Details below:</p>
            ...
            <form action="<?php echo INSTALL_URL; ?>?controller=Install&action=step1" method="POST">
                <div class="mb-3">
                    ...
                    ?>" required>
                    <div class="form-text">Usually "localhost" (e.g. localhost:8111) or an IP Address (e.g. 127.0.0.1)
                    </div>
                </div>
                <div class="mb-3">
