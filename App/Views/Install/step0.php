<div class="install-container">
    <div class="install-logo">
        <h1>Installator of Elec-Transport</h1>
    </div>
    <div class="card shadow-sm">
        <div class="card-body">
            <h2 class="card-title text-center mb-4">Welcome to the Installation Wizard</h2>
            <p class="card-text">This wizard will guide you through the installation process of the application. Please
            ...
            <p class="card-text">The installation process consists of 5 steps and should take about 5 minutes to
                complete.</p>
            <div class="d-grid gap-2">
                <a href="<?php echo INSTALL_URL; ?>?controller=Install&action=step1"
                    class="btn btn-primary btn-lg">Begin The Installation</a>
            </div>
        </div>
    </div>
    <div class="mt-4 text-center text-muted">
        <small>Installation Elec-Transport-Wizard == -- Welcome --</small>
    </div>
</div>